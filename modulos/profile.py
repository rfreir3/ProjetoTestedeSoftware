...
class User():
    ...
    def tela_user(self):
        ...
        opcao_01 = ctk.CTkButton(side_bar_frame, text= "Perfil", font= ("Roboto", 15), fg_color= "#363636", hover_color="#4F4F4F")
        opcao_01.pack(padx= 10, pady= 10)
        ...
        add_image_button = ctk.CTkButton(post_here_frame, text= "Adicionar imagem", font= ("Roboto", 15), fg_color= "#363636", hover_color="#4F4F4F")
